...
// processes to communicate with and and manage the lifetime of a fnod child
...
// message, shutdown begins.  This prevents fnod from continuing to run
...
// for a child fnod process to communicate with a parent process without the
