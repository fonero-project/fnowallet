...
// nodeConfig contains all the args, and data required to launch a fnod process
...
// command returns the exec.Cmd which will be used to start the fnod process.
...
// to connect to the fnod process that is launched via Start().
...
// as the base for the log and data directories for fnod.
...
// Start creates a new fnod process, and writes its pid in a file reserved for
...
// Stop interrupts the running fnod process, and waits until it exits properly.
