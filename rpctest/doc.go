// Package rpctest contains tests for fnowallet's RPC server and a harness used
// to facilitate the tests by setting up a temporary Simnet node and wallet. The
// RPC client implementation in fnorpcclient is used exclusively to test the RPC
...
//    3. High balance to maintain (2000000 FNO).
