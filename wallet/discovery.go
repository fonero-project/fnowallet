...
import (
	...
	hd "github.com/fonero-project/fnod/hdkeychain"
	...
	"github.com/fonero-project/fnowallet/validate"
...
// exists address index of a trusted fnod RPC server.
type existsAddrIndexFinder struct {
	wallet *Wallet
	client *rpc.Client
}

func (f *existsAddrIndexFinder) addressesUsed(addrs []fnoutil.Address) (bitset.Bytes, error) {
	const op errors.Op = "fnod.jsonrpc.existsaddresses"
