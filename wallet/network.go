...
// Peer provides wallets with a subset of Fonero network functionality available
// to a single peer.
type Peer interface {
...
// NetworkBackend provides wallets with Fonero network functionality.  Some
...
type NetworkBackend interface {
	Peer
	LoadTxFilter(ctx context.Context, reload bool, addrs []fnoutil.Address, outpoints []wire.OutPoint) error
	...
	StakeDifficulty(ctx context.Context) (fnoutil.Amount, error)
}
