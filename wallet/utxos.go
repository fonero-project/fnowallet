...
func (w *Wallet) SelectInputs(targetAmount fnoutil.Amount, policy OutputSelectionPolicy) (inputDetail *txauthor.InputDetail, err error) {
...
func (w *Wallet) OutputInfo(out *wire.OutPoint) (OutputInfo, error) {
	...
	err := walletdb.View(w.db, func(dbtx walletdb.ReadTx) error {
		...
		info.Amount = fnoutil.Amount(txDetails.TxRecord.MsgTx.TxOut[out.Index].Value)
