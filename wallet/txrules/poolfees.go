...
func StakePoolTicketFee(stakeDiff fnoutil.Amount, relayFee fnoutil.Amount,
	height int32, poolFee float64, params *chaincfg.Params) fnoutil.Amount {
	...
	return fnoutil.Amount(num.Int64())
}
