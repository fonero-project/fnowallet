...
import (
	...
	"github.com/fonero-project/fnoutil"
	"github.com/fonero-project/fnoutil/hdkeychain"
	"github.com/fonero-project/fnowallet/wallet/internal/txsizes"
	"github.com/fonero-project/fnowallet/wallet/walletdb"
	_ "github.com/fonero-project/fnowallet/wallet/internal/bdb"
...
func setup() error {
	...
	return walletdb.Update(db, func(dbtx walletdb.ReadWriteTx) error {
		...
		wif, err := fnoutil.NewWIF(privKey, chainParams, chainec.ECTypeSecp256k1)
		if err != nil {
			return err
		}
...
func createUnsignedTicketPurchase(prevOut *wire.OutPoint,
	inputAmount, ticketPrice fnoutil.Amount) (*wire.MsgTx, error) {
	...
	pkScript, err = txscript.GenerateSStxAddrPush(addr,
		fnoutil.Amount(amountsCommitted[0]), ticketFeeLimits)
	if err != nil {
		return nil, err
	}
