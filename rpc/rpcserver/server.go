...
//
//   https://github.com/fonero-project/fnowallet/blob/master/rpc/documentation/api.md
//
// Any API changes must be performed according to the steps listed here:
//
//   https://github.com/fonero-project/fnowallet/blob/master/rpc/documentation/serverchanges.md
package rpcserver
...
import (
	...
	"github.com/fonero-project/fnod/addrmgr"
	...
	"github.com/fonero-project/fnowallet/internal/cfgutil"
	h "github.com/fonero-project/fnowallet/internal/helpers"
	"github.com/fonero-project/fnowallet/internal/zero"
	"github.com/fonero-project/fnowallet/loader"
	"github.com/fonero-project/fnowallet/netparams"
	"github.com/fonero-project/fnowallet/p2p"
	pb "github.com/fonero-project/fnowallet/rpc/walletrpc"
	"github.com/fonero-project/fnowallet/spv"
	"github.com/fonero-project/fnowallet/ticketbuyer"
	tbv2 "github.com/fonero-project/fnowallet/ticketbuyer/v2"
...
// fnoutil.DecodeAddress, which does not perform the network check.
func decodeAddress(a string, params *chaincfg.Params) (fnoutil.Address, error) {
	addr, err := fnoutil.DecodeAddress(a)
	if err != nil {
...
// as well as establishing a RPC connection to a fnod consensus server.
...
func (s *walletServer) NextAddress(ctx context.Context, req *pb.NextAddressRequest) (
	*pb.NextAddressResponse, error) {
	...
	pubKeyAddr, err := fnoutil.NewAddressSecpPubKey(pubKey.Serialize(), s.wallet.ChainParams())
	if err != nil {
		return nil, translateError(err)
	}
...
func (s *walletServer) ImportPrivateKey(ctx context.Context, req *pb.ImportPrivateKeyRequest) (
	*pb.ImportPrivateKeyResponse, error) {
	...
	wif, err := fnoutil.DecodeWIF(req.PrivateKeyWif)
	if err != nil {
		return nil, status.Errorf(codes.InvalidArgument,
...
func (s *walletServer) ImportScript(ctx context.Context,
	...
	p2sh, err := fnoutil.NewAddressScriptHash(req.Script, s.wallet.ChainParams())
	if err != nil {
		return nil, translateError(err)
	}
...
func (s *walletServer) SweepAccount(ctx context.Context, req *pb.SweepAccountRequest) (*pb.SweepAccountResponse, error) {
	...
	if req.FeePerKb > 0 {
		var err error
		feePerKb, err = fnoutil.NewAmount(req.FeePerKb)
		if err != nil {
...
func (s *walletServer) BlockInfo(ctx context.Context, req *pb.BlockInfoRequest) (*pb.BlockInfoResponse, error) {
	...
	return &pb.BlockInfoResponse{
		...
		ApprovesParent:   header.VoteBits&fnoutil.BlockValid != 0,
	}, nil
}
...
func (s *walletServer) UnspentOutputs(req *pb.UnspentOutputsRequest, svr pb.WalletService_UnspentOutputsServer) error {
	...
	inputDetail, err := s.wallet.SelectInputs(fnoutil.Amount(req.TargetAmount), policy)
...
func (s *walletServer) FundTransaction(ctx context.Context, req *pb.FundTransactionRequest) (
	*pb.FundTransactionResponse, error) {
	...
	if req.IncludeChangeScript && inputDetail.Amount > fnoutil.Amount(req.TargetAmount) {
...
func (s *walletServer) ConstructTransaction(ctx context.Context, req *pb.ConstructTransactionRequest) (
	*pb.ConstructTransactionResponse, error) {
	...
	if req.FeePerKb != 0 {
		feePerKb = fnoutil.Amount(req.FeePerKb)
	}
...
func (s *walletServer) PurchaseTickets(ctx context.Context,
	...
	// purchase request.
	spendLimit := fnoutil.Amount(req.SpendLimit)
	if spendLimit < 0 {
		return nil, status.Errorf(codes.InvalidArgument,
	...
	txFee := fnoutil.Amount(req.TxFee)
	ticketFee := s.wallet.TicketFeeIncrement()

	// Set the ticket fee if specified
	if req.TicketFee > 0 {
		ticketFee = fnoutil.Amount(req.TicketFee)
	}
...
func (s *walletServer) ValidateAddress(ctx context.Context, req *pb.ValidateAddressRequest) (*pb.ValidateAddressResponse, error) {
	...
	case udb.ManagedPubKeyAddress:
		...
		pubKeyAddr, err := fnoutil.NewAddressSecpPubKey(result.PubKey,
...
func marshalBlock(v *wallet.Block) *pb.BlockDetails {
	...
	return &pb.BlockDetails{
		...
		ApprovesParent: v.Header.VoteBits&fnoutil.BlockValid != 0,
		Transactions:   txs,
	}
}
...
func (t *ticketbuyerV2Server) RunTicketBuyer(req *pb.RunTicketBuyerRequest, svr pb.TicketBuyerV2Service_RunTicketBuyerServer) error {
	...
	tb.AccessConfig(func(c *tbv2.Config) {
		...
		c.Maintain = fnoutil.Amount(req.BalanceToMaintain)
...
func (s *messageVerificationServer) VerifyMessage(ctx context.Context, req *pb.VerifyMessageRequest) (
	*pb.VerifyMessageResponse, error) {
	...
	addr, err := fnoutil.DecodeAddress(req.Address)
	if err != nil {
		return nil, translateError(err)
	}
